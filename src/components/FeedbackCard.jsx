...
const FeedbackCard = ({ content, contentSpanish, name, title, img, link }) => {
  ...
  const showContentP = windowWidth >= 760 ? (
    <p className="font-poppins font-normal text-[18px] leading-[32px] text-white my-2 hidden sm:flex">
        ...
        <a href={link} target="_blank">
          <div className="flex flex-col items-center">
            <img
              src={img}
              alt={name}
              className="sm:rounded-3xl w-[184px] sm:w-[226px] sm:h-[200px] object-cover shadow-2xl rounded-lg"
            />
